...
const AboutSection = () => {
  return (
    <section id="about" className="relative py-20 lg:py-25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Being part of the executive committee is more than a title—it's a transformative experience.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className="glass-card p-6 text-center group hover:glow-border transition-all duration-300 animate-fade-up"
